...
const INTEGRATIONS: IntegrationDef[] = [
  ...
  },
  {
    id: 'zapier',
    name: 'Zapier',
    description: 'Connect Viptant to 6,000+ apps with no-code Zaps triggered by your CRM and AI events.',
    category: 'Automation',
...
export default function IntegrationsPage() {
  ...
  return (
    <div className="flex flex-col gap-8 max-w-[1400px] mx-auto pb-12">
      <PageHeader
        title="Integrations"
        description="Connect Viptant to your existing toolstack. OAuth flows, webhook endpoints, and data sync."
      ...
      <div className="p-5 rounded-xl border border-violet-500/15 bg-violet-500/5 flex flex-col gap-3">
        ...
        <p className="text-[12px] text-neutral-400">
          Send events from any platform to Viptant using your organization's webhook endpoint:
        </p>
        <code className="text-xs font-mono text-violet-300 bg-neutral-900 border border-white/5 px-3 py-2 rounded-lg">
          POST https://api.viptant.com/api/v1/webhooks/inbound/{'{'}org_id{'}'}
        </code>
      </div>
    </div>
  );
